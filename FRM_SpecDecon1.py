...
def main():
    ...
    if uploaded_file is not None:
        ...
        selected_time = st.sidebar.slider(
            ...
            value=float(time_axis[len(time_axis) // 2]),
            step=float(analyzer.sample_rate)
        )
        ...
        num_frequencies = st.sidebar.slider("Number of Frequencies", 20, 100, 50)
        ...
        if 'spectral_components' in st.session_state:
            ...
            <ul>
            <li>Use the <b>time slider</b> in the sidebar to select different analysis times</li>
            ...
            characteristics = st.session_state.analyzer._get_spectral_characteristics(
                spectrum, frequencies, current_time
            )
            ...
            with col3:
                ...
                if characteristics['dominant_frequency'] < 20:
                    st.info("🔵 **Low Frequency**: Potential tuning effects")
                elif characteristics['dominant_frequency'] < 40:
                    st.info("🟢 **Mid Frequency**: Good resolution")
                else:
                    st.info("🟡 **High Frequency**: Thin bed resolution")
        ...
        <div style='text-align: center; padding: 4rem;'>
            ...
            <div class="info-box" style='max-width: 600px; margin: 2rem auto;'>
                ...
                <ul style='text-align: left;'>
                    ...
                    <li>Interactive time selection</li>
                    <li>Synchronized zoom between plots</li>
