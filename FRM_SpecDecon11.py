        ...
        with tab1:
            ...
            if 'ricker_spectral_components' in st.session_state:
                ...
                <div class="click-instruction">
                    🖱️ <b>NEW FEATURE:</b> Click directly on the Continuous Frequency Volume plot to select the analysis time!
                </div>
                """, unsafe_allow_html=True)
                ...
                <li><b>NEW:</b> Click directly on the <b>Continuous Frequency Volume</b> plot to select time</li>
        ...
        <div style='text-align: center; padding: 4rem;'>
            ...
            <div class="info-box" style='max-width: 600px; margin: 2rem auto;'>
                ...
                <ul style='text-align: left;'>
                    ...
                    <li><b>NEW:</b> Click directly on plots to select analysis time</li>
